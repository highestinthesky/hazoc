...
1. Review the upgraded `Market Journal` live with haolun and tighten the remaining quality gaps: sharper likely-read language, better evidence defaults, and better per-user usefulness.
