...
- Push meaningful GitHub changes roughly every other hour while active; a recurring reminder only counts after a real commit/push or a verified clean/no-change check.
